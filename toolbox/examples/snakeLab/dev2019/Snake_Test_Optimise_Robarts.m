...
function Snake_Test_Optimise_Robarts
...
Speed = 0.05;						%Timer speed, so inversely proportional to snake speed..
...
GameFig = figure ('Renderer','painters','WindowState','maximized','MenuBar','none','color',[0.1 0.1 0.1],'KeyPressFcn',@KeyAct); %#ok<FGREN,NASGU>
